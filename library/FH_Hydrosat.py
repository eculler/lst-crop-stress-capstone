'''
Important: This code was developed by the project sponsor to faciliate
interaction with the sponsor's API. It is necessary for project workflows
but should not be considered part of the project submission.
